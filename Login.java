...
public class Login extends JFrame implements ActionListener {
	...
	public Login() {
		...
		bedrockLogoPanelLeft
				.setIcon(new ImageIcon(Login.class.getResource("/supermarket/images/bedrockmart_logo100x70.png")));
		...
		footerLogoLabel.setIcon(new ImageIcon(Login.class.getResource("/supermarket/images/bedrockmart-footer.png")));
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == clearButton) {
			...
			if(roles.getSelectedItem().toString().isBlank() || userNameField.getText().isBlank()
